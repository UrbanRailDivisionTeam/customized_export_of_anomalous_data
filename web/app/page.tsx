        ...
        <div className="flex min-h-svh flex-col p-4 sm:p-6 lg:p-8">
            <header className="mb-6 flex flex-wrap items-center justify-between gap-4">
                <div className="flex items-center gap-3 min-w-0">
                    <img src="/api/logo" alt="中车" className="h-7 w-7 flex-shrink-0" />
                    <h1 className="text-lg font-semibold tracking-tight whitespace-nowrap truncate">城轨制造中心 异常处理数据看板</h1>
                </div>
